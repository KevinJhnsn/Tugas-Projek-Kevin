...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center bg-finance p-4">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <Card className="shadow-2xl rounded-2xl border-2 border-border/20 bg-card/80">
          <CardHeader>
            <CardTitle className="text-2xl font-headline text-center">Masuk atau Daftar</CardTitle>
            <CardDescription className="text-center">
              Gunakan akun Google Anda untuk melanjutkan.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button variant="outline" className="w-full" onClick={handleGoogleLogin} suppressHydrationWarning>
